...
//		 std::ios::out | std::ios::trunc);
  ...
  NeutronEnTr.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/Cosmogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/CosmNeutronTrSpec2Muon.dat",
                   std::ios::out | std::fstream::app);
  NeutronEnDet.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/Cosmogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/CosmNeutronDetSpec2Muon.dat",
                    std::ios::out | std::fstream::app);
  NeutronBack.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/Cosmogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/CosmNeutronBackScatter2Muon.dat",
                   std::ios::out | std::fstream::app);
  NeutronDetBack.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/Cosmogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/CosmDetBackScatter2Muon.dat",
                   std::ios::out | std::fstream::app);
