...
public:
  ...
  std::vector<G4double> rlvx;
  std::vector<G4double> rlvy;
  ...
  std::vector<G4double> rlBvx;
  std::vector<G4double> rlBvy;
  ...
  std::vector<G4double> rdvx;
  std::vector<G4double> rdvy;
  ...
  std::vector<G4double> rdBvx;
  std::vector<G4double> rdBvy;
