...
//  G4bool   flag_flo;
  ...
  std::vector<G4double> elvx;
  std::vector<G4double> elvy;
  ...
  std::vector<G4double> elBvx;
  std::vector<G4double> elBvy;
  ...
  std::vector<G4double> edvx;
  std::vector<G4double> edvy;
  ...
  std::vector<G4double> edBvx;
  std::vector<G4double> edBvy;
