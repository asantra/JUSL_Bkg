...
//  G4Backtrace::Enable();
 ...
 /// added this to include high energy neutrons
 G4VUserPhysicsList* physics2 = new FTFP_BERT();
 runManager->SetUserInitialization(physics2);
 G4VUserPhysicsList* physics3 = new QGSP_BIC_HP();
...
//       G4cout << "I am inside G4UI_USE" << G4endl;
// #ifdef G4VIS_USE
//       UImanager->ApplyCommand("/control/execute initInter.mac");
//       G4cout << "I am inside G4VIS_USE" << G4endl;
// #endif
//       ui->SessionStart();
//       delete ui;
// #endif
