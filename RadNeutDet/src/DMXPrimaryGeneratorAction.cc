    ...
    : G4VUserPrimaryGeneratorAction()
{
  ...
  */
  ...
  G4String path = "/Users/arkasantra/arka/BkgJUSL/JUSLFiles/Comp2/FullSpec_";
  path = path + fn + ".dat";
  G4cout << path << G4endl;
  ...
  energySpectrum.open("/Users/arkasantra/arka/BkgJUSL/OutputDirectory/Neutrons/Radiogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/NeuSpec_generated_" + std::to_string(id) + ".dat",
                      std::ios::out | std::fstream::app);
  particlePosition.open("/Users/arkasantra/arka/BkgJUSL/OutputDirectory/Neutrons/Radiogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/ParticlePostion_generated_" + std::to_string(id) + ".dat",
                        std::ios::out | std::fstream::app);
  particleDirection.open("/Users/arkasantra/arka/BkgJUSL/OutputDirectory/Neutrons/Radiogen/DataFiles/MTFiles/Hemisphere/2.5mThick/SiO2_norm/LowDen/Comp1/ParticleDirection_generated_" + std::to_string(id) + ".dat",
                         std::ios::out | std::fstream::app);
  i = 0;
  pid = 2112;
}
