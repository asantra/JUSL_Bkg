...
void B1SteppingAction::UserSteppingAction(const G4Step *step)
{
  ...
  if (volume == fScoringVolume)
  {
    ...
    if (atrack->GetDefinition()->GetParticleName() == "mu-" || atrack->GetDefinition()->GetParticleName() == "mu+" || atrack->GetDefinition()->GetParticleName() == "neutron" || atrack->GetDefinition()->GetParticleName() == "anti_neutron") // changed to mu- and mu+ both
    {
      ...
      G4cout << "From B1Stepping Action: counter " << fEventAction->counter << G4endl;
      if (fEventAction->counter == 0)
      {
        ...
        G4cout << "From B1Stepping Action: Ken " << PreEkin << G4endl; 
