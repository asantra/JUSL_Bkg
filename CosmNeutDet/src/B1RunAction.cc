      ...
      fEdep2(0.)
{
  ...
  final.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/2mData/NewRock/SiO2_norm/Muons_2m_NR_terr_c5_" + std::to_string(id) + ".dat", fstream::app);
  primaries.open("/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/CosmNeut/2mData/NewRock/SiO2_norm/GeantGeneratedMuons_554m_NR_terr_c5_" + std::to_string(id) + ".dat", fstream::app);
