...
def main():
   ...
   parser.add_argument('-f', type=str, default="GeantGeneratedMuons_554m_combined.dat")        #FOR 815M DEPTH: GeantGeneratedMuons_814m_combined.dat
   ...
   inputfolder = "/home/slab/Monalisa/ClusterOutput"
#    inputfolder = "/home/slab/Monalisa/JUSL_Bkg/JUSLFiles/Muons_815m/815mData/NewRock/SiO2_norm"        # FOR 815M DEPTH 
   ...
   T_sec = 600000 / (A * exp_flux)  # seconds            #600000   #1335000
